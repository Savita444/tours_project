    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <br>
                <span><small><b>Available seats:</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <input class="form-control text-center me-3" id="inputQuantity" type="num" value="1" style="max-width: 3rem; display: none;" name="quantity" />
                    <button class="btn btn-outline-dark flex-shrink-0" type="submit">
                        <i class="bi-cart-fill me-1"></i>
                        Add Tour For Booking
                    </button>
                </div>
                </form>
