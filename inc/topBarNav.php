            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endif; ?>
                        <?php endwhile; ?>
                        <li class="nav-item"><a class="nav-link" href="./?p=feedback">Feedback</a></li>

                        <li class="nav-item"><a class="nav-link" href="./?p=about">About</a></li>
                    </ul>
                    <button class="btn btn-outline-dark ml-2" id="feedback-btn" type="button">Feedback</button>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        <button class="btn btn-outline-dark ml-2" id="login-btn" type="button">Login</button>
                        <?php else: ?>
                        <a class="text-dark nav-link select_tour select-tour" href="./?p=cart">
                          <!-- mr-2 -->
