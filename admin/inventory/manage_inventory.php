...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Tours Price & Available Seats</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="product_id" class="control-label">Tour</label>
            ...
            <div class="form-group">
				<label for="size" class="control-label">Starting</label>
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Total Seats</label>
